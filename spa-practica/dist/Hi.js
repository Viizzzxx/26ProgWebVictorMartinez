...
function createInjectorButtonComponent(text, b) {
  const button = document.createElement("button");
  button.textContent = text;
  button.classList.add("btn");
  button.addEventListener("click", () => {
...
var button1 = createButtonEvP("Botón 1 final", "01", "btn", {
  event: "click",
  handler: () => {
    console.log("botón final ejecutado");
  }
});
var button2 = createInjectorButtonComponent("Botón 2: insertar botón 1", button1);
createInjectorButtonComponent("Botón 3: insertar botón 2", button2);
...
routerSimple("Home", "<h2>Home</h2><p>Bienvenido a la página principal.</p>");
routerSimple("About", "<h2>About</h2><p>Esta sección contiene información sobre la SPA.</p>");
routerSimple("Contact", "<h2>Contact</h2><p>Correo de contacto: alumno@ejemplo.com</p>");
